...
class text_processing:
    mask_ordinance = r'PORTARIA[\s\w]*[Nn]*[\.°:]*\s*(\d*/\d*)'
    ...
    def ls(page_text, search_date, dom_link):
        n_ordinance = re.findall(text_processing.mask_ordinance, page_text.upper())[0]
    ...
    def condition_review(ordinance_text, search_date, link):
        n_ordinance = re.findall(text_processing.mask_ordinance, ordinance_text.upper())[0]
...
def _import_date(search_date):
    ...
    files, links, folder = pdfutils.dom_bjlapa(search_date)

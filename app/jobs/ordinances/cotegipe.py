...
class text_processing:
    mask_ordinance = r'[Portaria|PORTARIA]\s*[de|DE]*\s*([nN][°:]*\s*)?(\d*/\d*)'
    mask_year = r'\d{4}'
...
def _import_date(search_date):
    ...
    type2function = {
        ...
        type_list[9]: 'license_renewal',
        type_list[10]: 'tt',
        type_list[11]: 'condition_review',
        type_list[12]: 'erratum'
    }

    files, links, folder = pdfutils.dom_cotegipe(search_date)

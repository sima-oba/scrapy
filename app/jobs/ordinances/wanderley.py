...
class text_processing:
    ...
    def erratum(text, search_date, link):
        ...
        old_text = re.findall(r'ONDE\s*[LlIéeE]*[–SE:]*\s*(.*)LEIA', text)[0]
        new_text = re.findall(r'LEIA–SE:(.*)\. ', text)[0]
...
def _import_date(search_date):
    ...
    files, links, folder = pdfutils.dom_wanderley(search_date)
